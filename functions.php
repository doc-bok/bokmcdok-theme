...
function improved_trim_excerpt($text) {
	...
	//  Don't display anything past the first subheading.
	$h3pos = strpos($text, "<h3");
	if ($h3pos != FALSE)
	{
		$text = substr($text, 0, $h3pos);
	}			
	...
	$text = strip_tags($text, '<p><em><strong><h3>');

	//  Increase the length to 50 words.
	$excerpt_length = 35;
