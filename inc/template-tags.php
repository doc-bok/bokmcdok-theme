...
if ( ! function_exists( 'bokmcdok_posted_on' ) ) :
	/**
	...
	function bokmcdok_posted_on(): void {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'bokmcdok' ),
...
if ( ! function_exists( 'bokmcdok_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'bokmcdok_entry_footer' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'bokmcdok' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'bokmcdok' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'bokmcdok_post_thumbnail' ) ) :
	/**
